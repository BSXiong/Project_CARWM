% Bingsen Modified @2017-9-27
% addpath(genpath('/brain/iCAN/home/xiongbingsen/SPM/spm12/toolbox/ArtRepair'));
%% Check % fMRI design specification
% matlabbatch{1}.spm.stats.fmri_spec.timing.fmri_t = 16;   % microtime resolution 33
% matlabbatch{1}.spm.stats.fmri_spec.timing.fmri_t0 = 8;   % Microtime onset 17
...
% matlabbatch{1}.spm.stats.fmri_spec.sess.hpf = *128 or 256
% matlabbatch{1}.spm.stats.fmri_spec.mthresh  = *0.8 or 0.5 or 0.1
% matlabbatch{1}.spm.stats.fmri_spec.global   = *None or Scaling
% 
% Get TR value: TR = 2
%%
...
% /home/fmri/fmrihome/SPM/spm8_scripts/IndividualStats/individualstats_config.m.template
%
...
function IndividualStats(Config_File)
...
disp('==================================================================');
fname = sprintf('IndividualStats-%d_%02d_%02d-%02d_%02d_%02.0f.log',c);  % Lei Hao 2017/03/10  % _',ResPostFix,'
diary(fname);
...
for subcnt = 1:numsub
    ...
    if include_artrepair == 1
        addpath(genpath('/brain/iCAN/home/xiongbingsen/SPM/spm12/toolbox/ArtRepair'));  % Bingsen
...
load(fullfile (template_path,'IndividualStats_Batch.mat'));  % Bingsen
...
%% Bingsen added 2016-12-15
% matlabbatch{1}.spm.stats.fmri_spec.sess.hpf = 256;       % original value is 128
% matlabbatch{1}.spm.stats.fmri_spec.mthresh = 0.5;        % original value is 0.8
% matlabbatch{1}.spm.stats.fmri_spec.global = 'Scaling';   % original value is 'None'
...
for sess = 1:numsess
    ...
    if(numsess == 1)
        taskdesign_file = fullfile(statsdir, 'task_design.mat');  % Bingsen
    else
        taskdesign_file = sprintf('%s/task_design_sess%d.mat', statsdir, sess);  % Bingsen
    end
